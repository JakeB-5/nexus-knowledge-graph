...
export default function LoginPage() {
  ...
  return (
    <>
      ...
      <p className="text-nexus-300 text-sm mb-6">Sign in to your account</p>
        ...
        <div className="flex items-center justify-between">
          <label className="flex items-center gap-2 cursor-pointer">
            <input
              ...
              className="w-4 h-4 rounded border-white/20 bg-white/10 text-nexus-500 focus:ring-nexus-400"
            />
            <span className="text-sm text-nexus-300">Remember me</span>
          </label>
          <Link href="/auth/forgot-password" className="text-sm text-nexus-400 hover:text-nexus-200 transition">
            Forgot password?
          </Link>
        </div>
      ...
      <div className="mt-6">
        <div className="relative flex items-center gap-3">
          ...
          <span className="text-xs text-nexus-400">or continue with</span>
          <div className="flex-1 h-px bg-white/10" />
        </div>

        <div className="mt-4 grid grid-cols-2 gap-3">
          <button className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-white/10 border border-white/20 text-white text-sm hover:bg-white/20 transition">
      ...
      <p className="mt-6 text-center text-sm text-nexus-400">
        ...
        <Link href="/auth/register" className="text-nexus-300 hover:text-white font-medium transition">
          Create one
        </Link>
      </p>
    </>
